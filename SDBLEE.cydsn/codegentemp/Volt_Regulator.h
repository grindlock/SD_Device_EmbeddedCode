...
#define Volt_Regulator_DEFAULT_VREF_SEL               (2u)
...
#define Volt_Regulator_DEFAULT_VREF_MV_VALUE          (1024)
#define Volt_Regulator_DEFAULT_BUFFER_GAIN            (0u)
#define Volt_Regulator_DEFAULT_AVG_SAMPLES_NUM        (7u)
#define Volt_Regulator_DEFAULT_AVG_SAMPLES_DIV        (7u < 4u) ? (int16)(0x100u >> (7u - 7u)) : (int16)(0x100u >> 4u)
#define Volt_Regulator_DEFAULT_AVG_MODE               (1u)
#define Volt_Regulator_MAX_RESOLUTION                 (12u)
#define Volt_Regulator_DEFAULT_LOW_LIMIT              (1808u)
#define Volt_Regulator_DEFAULT_HIGH_LIMIT             (2032u)
#define Volt_Regulator_DEFAULT_COMPARE_MODE           (0u)
#define Volt_Regulator_DEFAULT_ACLKS_NUM              (1023u)
