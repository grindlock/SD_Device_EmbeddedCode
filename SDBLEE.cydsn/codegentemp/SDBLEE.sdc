...
# Date: Tue, 22 Oct 2019 20:12:56 GMT
#set_units -time ns
create_clock -name {Volt_Regulator_intClock(FFB)} -period 625 -waveform {0 312.5} [list [get_pins {ClockBlock/ff_div_6}]]
...
create_generated_clock -name {Volt_Regulator_intClock} -source [get_pins {ClockBlock/hfclk}] -edges {1 31 61} [list]
...
# Project: C:\Users\sergio\Documents\PSoC Creator\SD_Device_EmbeddedCode\SDBLEE.cydsn\SDBLEE.cyprj
# Date: Tue, 22 Oct 2019 20:12:54 GMT
